...
Ext.define('RMdatalink.controller.ProductBillingController', {
    ...
    onRDStoreProductsListSelect: function(dataview, index, target, record, e, eOpts) {
        ...
        else if(record.data.ProductName == "E-Commerce"){
    ...
    initDatalinkBilling: function() {
        ...
        {
            if(this.config.isecomProduct){
                 Ext.ComponentQuery.query('#rtBillingHeaderLabel')[0].setHtml(rtRecord.get('store_name') + " : E-Commerce product setup");
            }else{
    ...
    removeDLDataOptions: function() {
        ...
        productList.select(dlDataRecord,true,true);
          ...
          dlDataRecord.set('quantity',vendorPricing.quantity );
    ...
    setDlDataPrice: function() {
            ...
            var dlDataRIndex = allMoulesStore.findExact('module_sku',"DL-DATA") ;
            if( dlDataRIndex == -1 ){
             return ;
            }
