Ext.define('RMdatalink.util.DataLoader', {
    ...
    doLoadStoresForRMDataLink: function() {
        ...
        this.loadProductDetailStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadVendorDetailStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadRetailerMasterStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadInhouseMasterStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadDiscountMasterStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadNotificationStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
        this.loadBillingMasterStore(scope, 1, _this.getpageSize(), _this.getEnableCache());
    },
    /*
     Set/Alter Default Pagination Values.
     */
    setPagingVariables: function(pageNo, pageSize, enableCache) {
        var _this = this;
        if (pageNo) {
        ...
        if (enableCache) {
            _this.setEnableCache(enableCache);
        }
    },
    ...
    loadNotificationStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
        if(enableCache){
       ...
       // RMdatalink.util.DataHandler.loadNotificationStore(scope,successCallBack,failuerCallBack);
         this.loadStoreFromDB(scope, 'notificationsNew', 'New_Notifications', 'rdl_new_notifications');
    },
    //loads only Billing store
    loadBillingMasterStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
       ...
       //    RMdatalink.util.DataHandler.loadBillingMasterStore(scope,successCallBack,failuerCallBack);  
             this.loadStoreFromDB(scope, 'billingMasterStore', 'billingDetailRecords', 'rdl_billingdetailrecords');
    },
    //loads only Product detailed store
    loadProductDetailStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
          ...
          this.loadStoreFromDB(scope, 'productDetailsRecordsStore', 'productDetailRecords', 'rdl_productdetailrecords');
    },
    //loads only Vendor detailed store
    loadVendorDetailStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
           ...
           this.loadStoreFromDB(scope, 'vendorDetailsRecodsStore', 'vendorDetailRecords', 'rdl_vendordetailrecords');

    },
    //loads only Retailer master store
    loadRetailerMasterStore: function(scope, pageNo, pageSize, enableCache,successCallBack,failuerCallBack){
...
//        
            ...
            this.loadStoreFromDB(scope, 'retailersMaster', 'masterRetailerRecords', 'rdl_masterretailerrecords');
    },
    //loads only Inhouse master store
    loadInhouseMasterStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
       ...
       //    RMdatalink.util.DataHandler.loadInhouseMasterStore(scope,successCallBack,failuerCallBack);  
        ...
        this.loadStoreFromDB(scope, 'inhouseMasterStore', 'inhouseRecords', 'rdl_inhouserecords');
    },
    //loads only Discount Master store
    loadDiscountMasterStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
        ...
        this.loadStoreFromDB(scope, 'discountsMasterStore', 'discounts', 'rdl_discounts');

    },
    
                //loads only Vendor master store
    loadVendorMasterStore: function(scope, pageNo, pageSize,enableCache,successCallBack,failuerCallBack) {
        console.log("Method to load Vendors Master data. Used Store is :: vendorsMaster");
        console.log("Important Note :: It is cumpulsary to call \"RMdatalink.util.globalMethods.fillDataFromMasterStore\" in successful callback");
     ...
     this.loadStoreFromDB(scope, 'vendors.Master', 'masterVendorRecords', 'rdl_vendor_masters');
