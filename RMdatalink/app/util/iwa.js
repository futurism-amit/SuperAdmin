Ext.define('RMdatalink.util.iwa', {
    ...
    rdl: {
        ...
        queryDB: function(options, callBackOK, callBackErr)
        {
            ...
            pr.query = this.getFilterToRemoveDeletedRec(options) ;//options.query;
        ...
        getFilterToRemoveDeletedRec: function(options) {
         
			var prevQuery = options.query ;
			if(options.isDeletedRecords){
				return prevQuery ;
			}
            /*var queryToReturn = {
                '$and': [
