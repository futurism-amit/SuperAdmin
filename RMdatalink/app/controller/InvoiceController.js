...
Ext.define('RMdatalink.controller.InvoiceController', {
    ...
    initInvoice: function(record) {
        ...
        if(msg){
            Ext.Msg.alert("Alert", " Please do product setup for "+ msg);
        }
    ...
    setRMProBillingModules: function() {
        ...
        Ext.ComponentQuery.query('#invoiceRmproSubtotal')[0].setValue(subTotal);
        Ext.ComponentQuery.query('#invoiceRmproSaving')[0].setValue(actualTotal - subTotal);
    ...
    setDatalinkBillingModules: function() {
        ...
        var rmProBilling = this.config.product_billing_rec.product_datalink ;
        ...
        ///changed function for datalink
        this.showHideDatalinkPromoPrice(selectedRate);

        var rmProStore = Ext.getStore('products.DatalinkMain') ;

        var addOnsStore = Ext.getStore('invoice.DatalinkModuleAddons') ;
        ...
        for(var i= 0 ; i < allSelectedModules.length; i++){
            ...
            var dataToAdd = {
                    ...
                    trial:allSelectedModules[i].trial,
                    quantity:allSelectedModules[i].quantity,
                    per_month:(allSelectedModules[i].quantity * rmProRec.get(selectedRate)),
                    module_standard_price :rmProRec.get('module_standard_price'),
                    module_promotional_price:rmProRec.get('module_promotional_price')

                };

                actualTotal += parseFloat(allSelectedModules[i].quantity * rmProRec.get('module_standard_price')) ;

                subTotal += parseFloat(allSelectedModules[i].quantity * parseFloat(rmProRec.get(selectedRate)) )  ;
                addOnsStore.addData(dataToAdd);
        ...
        ///set datalink add ons list height
        this.setDatalinkPacksAddonsHeight() ;



        // /data:

        Ext.ComponentQuery.query('#invoiceDatalinkSubtotal')[0].setValue(subTotal);
        Ext.ComponentQuery.query('#invoiceDatalinkSaving')[0].setValue(actualTotal - subTotal);


        //define datalink funcions
        this.setCommisionDatalinkFlds(rmProBilling);
    ...
    setInvoiceRmproDiscount: function(duration, isHistoryInvoice) {
        ...
        if(isHistoryInvoice){
            ...
            headerHtml = "Due Date :"+product_rmpro.due_date+" invoice_no: "+product_rmpro.invoice_number+" <b>Total Payble : "+totalPayble + "$</b> <span style='color:red;'> PAID</span>"  ;

        }else{

            headerHtml = "Due Date :"+product_rmpro.due_date+" invoice_no: "+product_rmpro.invoice_number+" <b>Total Payble : "+totalPayble + "$</b>"  ;
        }
    ...
    setInvoiceDatalinkDiscount: function(duration, isHistoryInvoice) {
        ...
        if(isHistoryInvoice){
                 headerHtml = "Due Date : "+product_datalink.due_date+" invoice_no: "+product_datalink.invoice_number+" <b>Total Payble : "+totalPayble + "$</b><span style='color:red;'> PAID</span>"  ;
        }else{
                headerHtml = "Due Date : "+product_datalink.due_date+" invoice_no: "+product_datalink.invoice_number+" <b>Total Payble : "+totalPayble + "$</b>"  ;
        }

        Ext.ComponentQuery.query('#billingDatalinkDtlsLbl')[0].setHtml(headerHtml);
    ...
    onRmproCommissionChange: function() {
        ...
        rmProInvoicePanel.down('#invoiceCommissionFld').setValue(commissionValue);
    },
    ...
    onDatalinkCommissionChange: function() {
        ...
        var commissionValue = parseFloat(amount) * parseFloat(commission)/100 ;
        rmProInvoicePanel.down('#invoiceDatalinkCommissionFld').setValue(commissionValue);
    },

    resetRmproInvoice: function() {
        Ext.ComponentQuery.query('#invoiceRmProPaymentPrdSlFld')[0].setValue(1) ;
        var rmProInvoicePanel = Ext.ComponentQuery.query('#productRmproInvoicePanel')[0] ;
    ...
    setRMProBillInVoice: function() {
        ...
        var product_rmpro = dataToUpdate.product_billng.product_rmpro ;
         ...
         rmProInvoicePanel.down('#invoicePayDateFld').setValue(product_rmpro.pay_date ) ;
        ...
        var totalPayble = parseInt(product_rmpro.monthly_membership) * (product_rmpro.payment_period ? parseInt(product_rmpro.payment_period) : 1) ;
    ...
    setDatalinkPrintInvoiceDetails: function() {
        var rmProBilling =  this.config.product_billing_rec.product_datalink ; // this.config.selectedRetailer.data.product_billng.product_datalink ;
        ...
        invoiceForm.down('#printinvoiceNofld').setValue( rmProBilling.invoice_number );
         ...
         invoiceForm.down('#printInvoiceTotalAmtFld').setValue( rmProInvoicePanel.down('#invoiceDatalinkTotalPaybleFld').getValue() );

         invoiceForm.down('#printInvoiceSubTotalAmtFld').setValue( rmProInvoicePanel.down('#invoiceDatalinkSubtotal').getValue() );


         invoiceForm.down('#printinvoiceTopDateFld').setValue(  rmProInvoicePanel.down('#invoiceDatalinkPayDateFld').getValue() ) ;

        invoiceForm.down('#printInvoicePaymentMethodLbl').setHtml("Payment Method : " + rmProInvoicePanel.down('#invoiceDatalinkPaidByFld').getValue() );


        invoiceForm.down('#printInvoiceCCApprovalLbl').setHtml("CC Approval #: " +  rmProInvoicePanel.down('#invoiceDatalinkCCApprovalFld').getValue()  );


         invoiceForm.down('#printinvoiceBottomDateFld').setValue( rmProInvoicePanel.down('#invoiceDatalinkPayDateFld').getValue() );//  rmProInvoicePanel.down('#invoiceDatalinkDateFld').getValue()) ;

        invoiceForm.down('#invoicePrintSavingFld').setValue( rmProInvoicePanel.down('#invoiceDatalinkTotalSavingFld').getValue()) ;

        invoiceForm.down('#printInvoiceAddOnsListPanel').setTitle("") ;

        invoiceForm.down('#printInvoiceProductLbl').setHtml("<b>Datalink</b>") ; //invoiceDatalinkTotalPaybleFld

        //invoiceForm.down('#printInvoiceTotalPaybleLbl').setHtml('<center><b>'+ rmProInvoicePanel.down('#invoiceDatalinkTotalPaybleFld').getValue() +'$</b><center>') ;

        invoiceForm.down('#printInvoiceProductDurationLbl').setHtml( rmProInvoicePanel.down('#invoiceDatalinkPaymentPrdSlFld').getValue() +' Month ( ' + rmProBilling.payment_period_start + ' to '+ rmProBilling.payment_period_end + ' )') ;


         invoiceForm.down('#printInvoiceBalanceDueFld').setValue( rmProInvoicePanel.down('#invoiceDatalinkBalanceDueFld').getValue() );


        invoiceForm.down('#printInvoiceAmtPaidFld').setValue(  rmProInvoicePanel.down('#invoiceDatalinkAmmountFld').getValue() ) ;


        invoiceForm.down('#printInvoiceTotalPaybleLbl').setHtml('<center><b>Invoice Amount : $ '+ rmProInvoicePanel.down('#invoiceDatalinkAmmountFld').getValue() +'</b><br/> Balance Due : $ '+
                                                                 rmProInvoicePanel.down('#invoiceDatalinkBalanceDueFld').getValue() +'<center>') ;
    ...
    setRmProPrintInvoiceDetails: function() {
        ...
        invoiceForm.down('#printinvoiceNofld').setValue( rmProBilling.invoice_number );
         ...
         invoiceForm.down('#printInvoiceTotalAmtFld').setValue( rmProInvoicePanel.down('#invoiceTotalPaybleFld').getValue() );
        ...
        invoiceForm.down('#invoicePrintSavingFld').setValue( rmProInvoicePanel.down('#invoiceTotalSavingFld').getValue()) ;



        invoiceForm.down('#printInvoiceProductLbl').setHtml("<b>RM-PRO</b>") ; //invoiceTotalPaybleFld

        invoiceForm.down('#printInvoiceTotalPaybleLbl').setHtml('<center><b>Invoice Amount : $ '+ rmProInvoicePanel.down('#invoiceAmmountFld').getValue() +'</b><br/> Balance Due : $ '+

                                                                rmProInvoicePanel.down('#invoiceBalanceDueFld').getValue() +'<center>') ;


         invoiceForm.down('#printInvoiceSubTotalAmtFld').setValue( rmProInvoicePanel.down('#invoiceRmproSubtotal').getValue() );
        ...
        invoiceForm.down('#printInvoiceProductDurationLbl').setHtml( rmProInvoicePanel.down('#invoiceRmProPaymentPrdSlFld').getValue() + ' Month ( ' + rmProBilling.payment_period_start + ' to '+ rmProBilling.payment_period_end + ' )') ;
         ...
         invoiceForm.down('#printInvoiceBalanceDueFld').setValue( rmProInvoicePanel.down('#invoiceBalanceDueFld').getValue() );

        invoiceForm.down('#printInvoiceAmtPaidFld').setValue(  rmProInvoicePanel.down('#invoiceAmmountFld').getValue() ) ;
    ...
    setDatalinkProductBilling: function() {
        ...
        var paymentsStore = Ext.getStore('DatalinkInvoicePaymentsStore') ;

        paymentsStore.removeAll();
        paymentsStore.sync() ;

        var payments =  that.config.product_billing_rec.product_datalink.payments ;
