/*
 * File: app/view/retailer/UserProductRMPRO.js
 *
...
Ext.define('RMdatalink.view.retailer.UserProductRMPRO', {
    extend: 'Ext.Panel',
    alias: 'widget.retailerUserProductRMPRO',
                        ...
                        items: [
                            {
                                ...
                                title: '<div style="line-height: 25px;">RM-PRO</div>',
                                cls: 'x-rm-rdformpanel',
                                itemId: 'rtuProductRMPROTab',
                                layout: 'vbox',
                                scrollable: true,
                                items: [
                                    {
                                        ...
                                        html: '<div style= "margin-left: -106px;"> Your current RM-PRO billing invoice.<span style="float:right;">#invoice  :</span> </div>',
                                    ...
                                    },
                                    {
                                        ...
                                        items: [
                                            ...
                                            },
                                            {
                                                ...
                                                height: '30px',
                                                html: '<div style="margin-left:20px;padding-top:5px !important;">Contract Term</div>',
                                                itemId: 'rtUserContractTermLbl',
                                                style: 'font-size:0.8em;',
                                                width: '100%'
                                            },
                                            {
                                                ...
                                                height: '30px',
                                                html: '<div style="margin-left:20px;padding-top:5px !important;">Product Setup</div>',
                                                style: 'font-size:0.8em;background-color:#DCDCDE;',
                                                width: '100%'
                                            },
                                            {
                                                xtype: 'panel',
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        items: [
                                                                            ...
                                                                            },
                                                                            {
                                                                                xtype: 'textfield',
                                                                                disabled: true,
                                                                                itemId: 'rtUserAdvancePaymentFld',
                                                                                inputCls: 'inputdisabledClsFldAsLbl',
                                                                            ...
                                                                            },
                                                                            {
                                                                                xtype: 'textfield',
                                                                                disabled: true,
                                                                                itemId: 'rtUserDiscountAppliedFld',
                                                                                inputCls: 'inputdisabledClsFldAsLbl',
                                                                            ...
                                                                            {
                                                                                xtype: 'checkboxfield',
                                                                                label: 'I have read this Agreement and agree to the  terms and conditions.',
                                                                                labelAlign: 'right',
                                                                                labelWidth: '90%',
                                                                                labelWrap: true
                                                                            },
                                                                            {
                                                                                ...
                                                                                margin: '10 0 10 80%',
                                                                                width: '220px',
                                                                                text: 'PAY & ACTIVATE SERVICE		'
                                                                            }
                                                                        ]
                                                                    },
                                                                    {
                                                                        xtype: 'formpanel',
                                                                        cls: 'x-rm-rdformpanel  x-rm-no_borderflds',
                                                                        docked: 'right',
                                                                        width: '360px',
                                                                        scrollable: false,
                                                                        items: [
                                                                            ...
                                                                            },
                                                                            {
                                                                                xtype: 'textfield',
                                                                                disabled: true,
                                                                                html: '<div style= "margin:-20px 0 0 -12px">$</div>',
                                                                                itemId: 'rtBillDiscountTxtFld',
                                                                                style: 'font-size:0.9em;',
                                                                                width: '80%',
                                                                                inputCls: 'inputTextRightAlign inputdisabledClsFldAsLbl',
                                                                                label: 'Discount',
                                                                                labelWidth: '180px'
                                                                            },
                                                                            {
                                                                            ...
                                                                            },
                                                                            {
                                                                                ...
                                                                                style: 'font-size:0.9em;',
                                                                                width: '80%',
                                                                                inputCls: 'inputdisabledClsFldAsLbl inputTextRightAlign',
                                ...
                                listeners: [
                                    {
                                        fn: function(element, eOpts) {
                                            RMdatalink.app.getController('RetailerPaymentController').calculateRMPRODiscountAndTotal() ;
                                        },
                                        event: 'painted'
                                    }
                                ]
