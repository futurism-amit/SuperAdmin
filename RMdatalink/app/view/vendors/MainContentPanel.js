                                ...
                                listeners: [
                                    {
                                        fn: function(component, eOpts) {
                                            ...
                                            '<div class="x-rm-listtpl-main" style="width: 99.5%;">',
                                            '    <div style="width: 8%;"> Vendor Logo&nbsp;',
                                            '        <div style="width: 25px;" data-name="all"></div>',
                                            '    </div>',
                                            '    <div style="width: 10%;" data-name="vendor_name">',
                                            '        Vendor Name&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 10%;" data-name="collections">',
                                            '        # of Collections&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 10%;" data-name="design">',
                                            '        # of Designs&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 7%;" data-name="SKU">',
                                            '    # of SKUs&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 8%;" data-name="vendor_monthly_subscription">',
                                            '    Price/Month&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 8%;" data-name="no_of_additional_images">',
                                            '         # of Images&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 13%;" data-name="manager_firstname">',
                                            ...
                                            '    </div>',
                                            '    <div style="width: 10%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{vendor_name}</div>',
                                            '    <div style="width: 10%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{collections}</div>',
                                            '    <div style="width: 10%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}" >{design}</div>',
                                            '    <div style="width: 7%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{SKU}</div>',
                                            '    <div style="width: 8%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{product_price.datalink.standard_price}</div>',
                                            '    <div style="width: 8%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{no_of_additional_images}</div>',
                                            '    <div style="width: 13%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getManager_LastNameDelegateClassForTap()]}" > {[this.getAccMgrName(values)]}</div>',
                                ...
                                listeners: [
                                    {
                                        fn: function(component, eOpts) {
                                            ...
                                            '        # of Collections&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 20%;" data-name="last_data_update">',
                                            '        Last Data Update&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 20%;" data-name="last_inventory_update">',
                                            '        Last Inventory Update&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            ...
                                            '    <div style="width: 10%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{vendor_name}</div>',
                                            '    <div style="width: 10%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "{[RMdatalink.util.globalConfig.getStore_nameDelegateClassForTap()]}"  >{collections}</div>',
                                            '    <div style="width: 20%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "last_data_update"  >{[this.getDataupdatedDate(values)]}</div>',
                                            '    <div style="width: 20%;" {[RMdatalink.util.globalConfig.getListAttrForDelHandling()]} = "last_inventory_update"  >{[this.getInventoryupdatedDate(values)]}</div>',
