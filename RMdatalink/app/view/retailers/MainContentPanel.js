                                ...
                                listeners: [
                                    {
                                        fn: function(component, eOpts) {
                                            ...
                                            Ext.create('Ext.XTemplate',
                                            '<div class="x-rm-listtpl-main">',
                                            '    <div class="pointerCursor boldText" style="width: 4%;overflow:visible;">',
                                            ...
                                            '        <div style="width: 9px; height:9px; background-color:{[this.getCheckBoxRound(values.store_products.datalink_status)]}"> <span style="margin-left: 10px;font-size: 12px; color:red;font-weight: bold;">{[RMdatalink.app.getController("RetailerDeatilsDataSet").config.billingQuery.getProductAlertText(values,"product_datalink")]}</span></div>',
                                            '    </div>',
                                            '    <div style="width: 5%;" class="checkRound">',
                                            ...
                                            '        <div style="width: 9px; height:9px; background-color:{[this.getCheckBoxRound(values.store_products.rmpro_status)]}"> <span style="margin-left: 10px;font-size: 12px; color:red;font-weight: bold;">{[RMdatalink.app.getController("RetailerDeatilsDataSet").config.billingQuery.getProductAlertText(values,"product_rmpro")]}</span></div>',
                                            '    </div>',
                                            '    <div style="width: 6%;" class="checkRound">',
                                            ...
                                            */
                                            ...
                                            '    <div style="width: 20%;text-align:right;">${[formatNum(values.monthly_payble)]}</div>',
                                            '</div>'
                                            )
                                            );
                                ...
                                listeners: [
                                    ...
                                    },
                                    {
                                        fn: function(element, eOpts) {
                                            ...
                                            RMdatalink.app.getController('PaginationController').setRetailersActiveTabPageNo( Ext.getStore('retailersMaster').config.maxPageNo) ;
