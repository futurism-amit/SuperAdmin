...
Ext.define('RMdatalink.view.products.RM_PROMain', {
                                ...
                                listeners: [
                                    {
                                        fn: function(component, eOpts) {
                                            ...
                                            '    </div>',
                                            '    <div style="width: 4%;" data-name="module_listed_order">',
                                            '        index&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 10%;" data-name="module_sku">',
                                            ...
                                            '    </div>',
                                            '    <div style="width: 32%;" data-name="module_description">',
                                            '       Description&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            '    <div style="width: 8%;" data-name="quantity">',
                                            '       Quantity&nbsp;<img src="resources/images/button_icons/downArrow.png"/>',
                                            '    </div>',
                                            ...
                                            '    </div>',
                                            '    <div style="width: 4%;"> {module_listed_order}</div>',
                                            '    <div style="width: 10%;">{module_sku}</div>',
                                            '    <div style="width: 15%;">{module_name}</div>',
                                            '    <div style="width: 32%;">{module_description}</div>',
    ...
    onInhouseMainContentPanelInitialize: function(component, eOpts) {
        ...
        component.down('#cardTitleLabel').setHtml("RM-PRO");
